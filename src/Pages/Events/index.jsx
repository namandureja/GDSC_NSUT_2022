    ...
    return (
        <div className={styles.eventDiv}>
            ...
            <div className={styles.eventHeading}>
                <h2 className={events === "U" ? styles.eventChange : ""} onClick={onClickUpcomingEventHandler}>
                    Upcoming Events
                </h2>
                <h2>|</h2>
                <h2 className={events === "P" ? styles.eventChange : ""} onClick={onClickPastEventHandler}>
                    Past Events
                </h2>
            </div>
            {events === "U" && (
                <div className={styles.eventsContainer}>
                    {eve.map((even) => {
                        return (
                            <>
                                <Card key={even.id} date={even.date} venue={even.venue} name={even.name} />
                            </>
                        );
                    })}
